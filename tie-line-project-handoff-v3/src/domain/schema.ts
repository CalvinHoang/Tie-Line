export type PhaseId = "L" | "alpha" | "beta";
export type PointRoleId =
  | "a-melt"
  | "b-melt"
  | "alpha-eut"
  | "eutectic"
...
export type PhaseKind = "liquid" | "terminal-solid";
...
export interface PuzzleDefinition {
  ...
  requiredInvariant: RequiredInvariantSpec;
...
export interface SolutionInvariant {
  type: "invariant-horizontal";
  startRoleId: PointRoleId;
  endRoleId: PointRoleId;
  interiorRoleIds: PointRoleId[];
