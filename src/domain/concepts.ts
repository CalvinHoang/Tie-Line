...
export const RULE_CONCEPTS: RuleConcept[] = [
  { id: "eutectic-point", title: "Eutectic point", category: "Critical points", diagram: "eutectic", reaction: "L → α + β", direction: "On cooling", transitionNote: "Liquid is consumed; alpha and beta form simultaneously.", rule: "One liquid becomes two solid phases on cooling.", cue: "Two liquidus branches meet a horizontal invariant line at a low point." },
  { id: "eutectoid-point", title: "Eutectoid point", category: "Critical points", diagram: "eutectoid", reaction: "γ → α + β", direction: "On cooling", transitionNote: "Gamma is consumed; two different solid phases form.", rule: "One solid phase separates into two different solids on cooling.", cue: "The three-phase invariant lies wholly below the solidus." },
  { id: "monotectic-point", title: "Monotectic point", category: "Critical points", diagram: "monotectic", reaction: "L₁ → L₂ + α", direction: "On cooling", transitionNote: "One liquid is consumed; a second liquid and alpha form.", rule: "One liquid transforms into a second liquid and a solid on cooling.", cue: "A liquid miscibility dome meets an invariant horizontal." },
  { id: "monotectoid-point", title: "Monotectoid point", category: "Critical points", diagram: "peritectoid", reaction: "α₁ → α₂ + β", direction: "On cooling", transitionNote: "One solid composition is consumed; another solid composition and beta form.", rule: "One solid solution becomes a second composition of that solid plus another solid.", cue: "A solid-state invariant with no liquid field touching it." },
  { id: "inverse-peritectic", title: "Inverse peritectic", category: "Critical points", diagram: "peritectic", reaction: "α₁ → α₂ + L", direction: "On cooling", transitionNote: "Alpha 1 is consumed; alpha 2 and liquid form.", rule: "A solid separates into another solid composition and liquid on cooling.", cue: "A peritectic-like junction with the reaction direction reversed." },
  { id: "liquid-spinodal", title: "Liquid spinodal", category: "Critical points", diagram: "spinodal", reaction: "L₁ → L₂ + L₃", direction: "On cooling", transitionNote: "The homogeneous liquid becomes unstable and separates continuously into two liquid compositions.", rule: "A liquid becomes unstable and separates continuously into two liquid compositions.", cue: "An inner spinodal curve sits inside a liquid miscibility gap." },
  { id: "solid-spinodal", title: "Solid spinodal", category: "Critical points", diagram: "miscibility-gap", reaction: "α₁ → α₂ + α₃", direction: "On cooling", transitionNote: "The homogeneous solid becomes unstable and separates continuously into two solid compositions.", rule: "A solid solution decomposes continuously into two solid compositions.", cue: "A solid-state miscibility dome contains the unstable composition range." },
  { id: "peritectic-point", title: "Peritectic point", category: "Critical points", diagram: "peritectic", reaction: "L + α → β", direction: "On cooling", transitionNote: "Liquid and alpha are consumed; beta forms.", rule: "A liquid and one solid react to form a different solid on cooling.", cue: "A liquidus branch terminates on a horizontal invariant beside another boundary." },
  { id: "peritectoid-point", title: "Peritectoid point", category: "Critical points", diagram: "peritectoid", reaction: "α + β → γ", direction: "On cooling", transitionNote: "Alpha and beta are consumed; gamma forms.", rule: "Two solids react to form a third solid on cooling.", cue: "The invariant and all adjoining fields are below the solidus." },
  ...
  { id: "solid-miscibility-gap", title: "Solid miscibility gap", category: "Diagram families", diagram: "miscibility-gap", rule: "A nominally continuous solid solution separates into two solid compositions inside a solvus dome.", cue: "A two-solid dome appears below the solidus." },
